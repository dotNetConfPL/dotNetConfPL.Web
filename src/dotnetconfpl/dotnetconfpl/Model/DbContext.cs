...
A teraz nagle orkiestracja to 'must - have' i nie da się pracować bez niej.
            ...
            var session5 = new Session {Speaker = januszNowak, Title = "Use Azure DevOps to depoly Azure Function in Docker on Raspberry Pi.", Time = "Sobota (5.10) 12:00 - 13:00", About = @"Using Azure DevOps Pipelines for creating and running Azure Functions in Container on Raspberry Pi.
